...
export default async function Home() {
  ...
  <h2 className="text-2xl font-extrabold mb-4 text-gray-900 dark:text-gray-100 tracking-tight border-l-4 border-blue-700 dark:border-blue-400 pl-3 py-2 bg-white dark:bg-gray-900
  rounded-r-md
  shadow-sm
">
  Curated Collections
