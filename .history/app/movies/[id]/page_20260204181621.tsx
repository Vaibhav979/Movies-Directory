...
<section className="mt-12">
  ...
  <h2 className="text-2xl font-extrabold mb-6 text-gray-900 dark:text-white border-l-4 border-blue-700 dark:border-blue-400 py-2 bg-white/80 dark:bg-gray-900/80  drop-blur
  rounded-r-md
">
  🎭 Cast
</h2>
