...
export default async function Home() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-8">
      ...
      <h1 className="text-6xl font-extrabold mb-4 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(168,85,247,0.35)]">
        Movie Directory
      </h1>
